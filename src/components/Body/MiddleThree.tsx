...
const MiddleThree: React.FC = () => {
  ...
  // const [isCursorOver, setIsCursorOver] = useState(false); // New state to track cursor position
  ...
  useEffect(() => {
    ...
    const handleMouseEnter = () => {
      scrolling = true; // Start scrolling when mouse enters
    };

    const handleMouseLeave = () => {
      scrolling = false; // Stop scrolling when mouse leaves
    };
    ...
    scrollContainer.addEventListener('mouseenter', handleMouseEnter); // Add mouse enter event

    scrollContainer.addEventListener('mouseleave', handleMouseLeave); // Add mouse leave event
    ...
    return () => {
      ...
      scrollContainer.removeEventListener('mouseenter', handleMouseEnter); // Clean up

      scrollContainer.removeEventListener('mouseleave', handleMouseLeave); // Clean up
